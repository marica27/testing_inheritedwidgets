...
class CustomSliverList extends SliverMultiBoxAdaptorWidget {
  ...
  @override
  RenderCustomSliverList createRenderObject(BuildContext context) {
    final SliverMultiBoxAdaptorElement element = context;
    return new RenderCustomSliverList(
...
class RenderCustomSliverList extends RenderSliverList {
  ...
  @override
  void performLayout1() {
    print("RenderCustomSliverList super initialIndex=${initialIndex}");
    super.performLayout();
    print("firstChild ${indexOf(firstChild)} lastChild ${indexOf(
        lastChild)} childCount=${childCount}");
  }
  ...
  void performLayout() {
    print(
        "RenderCustomSliverList initialIndex=${initialIndex} isBuildFirstTime=$isBuildFirstTime");
    ...
    // If it runs first time (before manual scrolling - scrollOffset is 0.0)
    ...
    print("firstChild = ${indexOf(firstChild)} = ${indexOf(child)}");
